...
class SingleBoolArduPar3 : public AbstractArduPar3
{
public:
  SingleBoolArduPar3() : value(0),
  ...
  void setValue(bool newValue); ///< set the value and rpint some debug info
  bool getValue() const{ return *valuePointer; }
...
protected:
  ...
  bool value;
  bool *valuePointer = nullptr;       ///< points to the parameter value to be set
